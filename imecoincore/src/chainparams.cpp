...
{
    const char* pszTimestamp = "IME Blockchain - 25/08/2020.";
    const CScript genesisOutputScript = CScript() << ParseHex("047a59021c86605e56ad41bf778cf2d7e52535285bfdfef5721eef8f577199a34a594a73f667e33ae60e0b8c8d47ab6e82aa98939cbc462e7fad0a7273ae481fe7") << OP_CHECKSIG; //minha chave publica gerada
...
public:
    CMainParams() {
        ...
        consensus.BIP34Height = 1000; //modificado
        consensus.BIP34Hash =  uint256S("0x0");
        consensus.BIP65Height = 1; // modificado
        consensus.BIP66Height = 1; // modificado
        consensus.CSVHeight = 419328; // 000000000000000004a1b34462cb8aeebd5799177f7a29cf28f2d1961716b5b5
        consensus.SegwitHeight = 481824; // 0000000000000000001c8018d9cb3b742ef25114f27563e3fc4a1902167f9893
        consensus.MinBIP9WarningHeight = 483840; // segwit activation height + miner confirmation window
        consensus.powLimit = uint256S("0000ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"); //modificado para ficar mais facil
        consensus.nPowTargetTimespan = 14 * 24 * 60 * 60; // two weeks
        consensus.nPowTargetSpacing = 3 * 60; //modificado
		...
		pchMessageStart[2] = 0x6c; // Modificado
		pchMessageStart[3] = 0xb5; // Modificado
        nDefaultPort = 1763; // Modificado
...
public:
    CTestNetParams() {
		...
		pchMessageStart[2] = 0x29; // Modificado
		pchMessageStart[3] = 0xfe; // Modificado
        nDefaultPort = 1764; // Modificado
